...
(function($) {
    ...
    var table = $('#projects-tbl').DataTable({
        ...
        buttons: [
            ...
            {
                extend: 'excel',
                text: '<i class="fa-solid fa-file-excel"></i> Exportar relatório',
    ...
    var table = $('#customer-tbl').DataTable({
        ...
        buttons: [{
            extend: 'excel',
            text: '<i class="fa-solid fa-file-excel"></i> Exportar relatório',
            className: 'btn btn-sm border-0 btn-spacing'
        }],
        searching: true,
        select: false,
        pageLength: 9,
    ...
    var table = $('#customer-tbl-receita').DataTable({
        //dom: 'Bfrtip',
        'dom': 'ZBfrltip',
        buttons: [
    ...
    var table = $('#customer-tbl-despesa').DataTable({
        //dom: 'Bfrtip',
        'dom': 'ZBfrltip',
        buttons: [
